...
include $(CLEAR_VARS)
LOCAL_MODULE := VoicePrintDemo
LOCAL_MODULE_OWNER := android
LOCAL_SRC_FILES := proprietary/vendor/app/VoicePrintDemo/VoicePrintDemo.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := android
LOCAL_SRC_FILES := proprietary/vendor/app/improveTouchStudio/improveTouchStudio.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
